<template>
    <div class=" w-full md:max-w-[758px] lg:max-w-[1150px] m-auto pb-4 px-4">
        <div class=" w-full flex flex-col items-center space-y-20">
            <div class=" flex flex-col items-center space-y-4 w-full">
                <div class=" flex flex-col items-center lg:-space-y-2 md:space-y-0 text-[24px] md:text-[28px] lg:text-[35px] font-bold font-inter">
            ...
            <div class=" w-full grid grid-cols-1 sm:grid-cols-3 gap-10 lg:gap-28 max-w-[200px] sm:max-w-max m-auto">
                <div class=" w-full card py-7 space-y-2 max-w-[200px] lg:max-w-[299px]">
